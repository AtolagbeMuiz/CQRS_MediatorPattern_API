...
namespace CQRS_MediatorPattern.Features.ProductFeatures.Queries
{
    public class GetProductByIdQuery : IRequest<Product>
    {
        ...
        public class GetProductByIdQueryHandler : IRequestHandler<GetProductByIdQuery, Product>
        {
            ...
            public GetProductByIdQueryHandler(IApplicationDBContext context, IDistributedCache distributedCache)
            {
                _context = context;
            ...
            public async Task<Product> Handle(GetProductByIdQuery query, CancellationToken cancellationToken)
            {
                ...
                {
                    product = await _context.Product.Where(a => a.Id == query.Id).AsNoTracking().FirstOrDefaultAsync();
